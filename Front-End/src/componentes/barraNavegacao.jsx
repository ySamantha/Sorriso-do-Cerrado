...
function BarraNavegacao() {
  ...
  const totalItemsNoCarrinho = cartItems.reduce(
          ...
          <li className={styles.menuUsuario}>
            ...
            {menuAberto && (
              <div className={styles.menuDropdown}>
                <Link to="/editar-dados" onClick={() => setMenuAberto(false)}>Editar Dados</Link>
        ...
        <li>
          <Link to="/favoritos" className={styles.linkFavoritos}>
            <svg
              ...
              className={styles.iconeFavoritos}
            >
